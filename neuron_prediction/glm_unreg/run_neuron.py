"""
SLURM entry point: fit unregularised GLM for one neuron

usage: python -m neuron_prediction.glm_unreg.run_neuron --job-index 42 --job-map /path/to/glm_job_map.csv
"""
import argparse
import pandas as pd
from neuron_prediction.glm_unreg.fit import fit_neuron_from_disk
