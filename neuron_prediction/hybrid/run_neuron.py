"""
SLURM entry point: fit hybrid model for one neuron

usage: python -m neuron_prediction.hybrid.run_neuron --job-index 42 --job-map hybrid_job_map.csv
"""
import argparse
import pandas as pd
from neuron_prediction.hybrid.fit import fit_neuron_from_disk
