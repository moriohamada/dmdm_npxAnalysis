"""
SLURM entry point: fit Poisson network for one neuron

usage: python -m neuron_prediction.network.run_neuron --job-index 42 --job-map network_job_map.csv
"""
import argparse
import pandas as pd
from neuron_prediction.network.fit import fit_neuron_from_disk
